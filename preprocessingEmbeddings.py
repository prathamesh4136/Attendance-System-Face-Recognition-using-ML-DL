...
embeddingModel = "C:/Users/DELL/AppData/Local/Programs/Python/Python39/30 Days/Day 18/openface.nn4.small2.v1.t7" #initializing model forembedding python
...
for (i, imagePath) in enumerate(imagePaths): 
        ...
        imageBlob = cv2.dnn.blobFromImage(
            ...
            #print("Blob shape:", imageBlob.shape)  # Print the shape of the blob
